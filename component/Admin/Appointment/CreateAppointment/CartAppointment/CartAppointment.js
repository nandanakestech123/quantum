...
export class CartAppointmentClass extends Component {
    state = {
        treatment: [],
        treatmentDetail: [],
    ...
    handleConfirmBooking = async() => {
        this.props.commonCreateApi(`itemcart/?Appointment_id=${this.props.match.params.id}`)
    }
            ...
            <>
                <div className="create-appointment container">
                    <div className="row">
                                ...
                                <div className="stepper">
                                    <div className="step-view step-3">
                                        <div className="timeline-view step d-flex justify-content-around">
                                            ...
                                            <div className=""><div className={``}><div className="timeline active"></div></div><p>Book Appointment</p></div>
                                            <div className=""><div className={`visited`}><div className="timeline active"></div></div><p>Add to cart</p></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="appointment-holder">
                                    <div className="treatment-section">
                                        <NormalIf isShow={activeTab === 'book-appointment'}>
                                            <p className="treatment-label fs-14 f-600">Booked Appointments</p>
                        ...
                        <Cart id={this.props.match.params.id}></Cart>
                    </div>
                </div>
            </>
        );
...
export const CartAppointment = connect(mapStateToProps, mapDispatchToProps)(CartAppointmentClass)