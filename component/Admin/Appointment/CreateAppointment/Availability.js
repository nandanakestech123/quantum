...
const Availability = ({ availability }) => {
  ...
  return (
    <div className="side-menus">
      <div color="primary" onClick={toggle} ><div className="row  pt-3">
      ...
      <Collapse isOpen={isOpen}>
        <div className="col-12 text-center fs-12">
          {/* <div className="col-6">8.30 - 9.30 </div>
          <div className="col-6">Giana Schleifer</div>
          <div className="col-6">10.30 - 12.30  </div>
          <div className="col-6">Randy Madsen</div>
          <div className="col-6">2.30 - 3.00  </div>
          <div className="col-6">Randy Gouse</div>
          <div className="col-6">5.00 - 6.30  </div>
          <div className="col-6">Omar Vetrovs</div> */}
