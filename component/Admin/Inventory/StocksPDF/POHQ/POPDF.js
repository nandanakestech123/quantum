      ...
      <View style={styles.container}>
        <View style={styles.headerNormalText}>
          ...
          <View style={styles.invoiceNoContainer}>
            ...
            <Text style={styles.label}> : </Text>
            <Text style={styles.leftvalue}>{listDetail.PO_STATUS}</Text>
          </View>
      ...
      <View style={styles.container}>
        <View style={styles.headerText}>
          <View style={styles.invoiceDateContainer}>
            <Text style={styles.rightlabelWidth}>Total Required Quantity</Text>
            <Text style={styles.label}> : </Text>
            <Text style={styles.rightvalue}>{listDetail.totalQty}</Text>
          </View>
          <View style={styles.invoiceDateContainer}>
            <Text style={styles.rightlabelWidth}>Total Required Amount</Text>
            <Text style={styles.label}> : </Text>
