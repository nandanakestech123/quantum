...
export class ListStockMemoClass extends React.Component {
  state = {
    headerDetails: [
      { label: "Date" },
      { label: "DOC Number" },
  ...
  getMEMO = () => {
    ...
    this.props
      .getCommonApi(
        `stockusagelist/?searchfrom=${dateFormat(
          From,
          "yyyy-mm-dd"
  ...
  render() {
    ...
    return (
      <div className="memo-section col-md-11 align-items-center">
        <div className="col-md-12">
          <p className="label-head mb-4">{t("Stock Memo Listing")}</p>
        </div>
        ...
        <div className="d-flex flex-wrap m-0 filter">
          ...
          <div className="col-md-2 col-12">
            ...
            <NormalButton
              ...
              label="Add Memo"
              outline={false}
              onClick={() => history.push("inventory/stockmemo/add")}
            />
          </div>
        </div>
                  ...
                  ? memoList.map((item, index) => {
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            <div className="d-flex align-items-center justify-content-center">
                              <Link to={`inventory/stockmemo/${PO_ID}/edit`}>
                                {DOC_NO}
                              </Link>
                            </div>
                          </td>
...
export const ListStockMemo = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(ListStockMemoClass)
);
