...
export class ProductDetailMain extends React.Component {
  render() {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.headerNormalText}>
          ...
          <View style={styles.invoiceNoContainer}>
            <Text style={styles.leftlabel}>Qty Hold</Text>
            <Text style={styles.label}> : </Text>
            <Text style={styles.leftvalue}>{accountHeader.totalholdqty}</Text>
          </View>
          <View style={styles.invoiceNoContainer}>
          ...
          <View style={styles.invoiceNoContainer}>
            <Text style={styles.leftlabel}>Credit Balance</Text>
            <Text style={styles.label}> : </Text>
            <Text style={styles.leftvalue}>$ {accountHeader.credit_balance}</Text>
          </View>
        </View>
        <View style={styles.headerText}>
          <View style={styles.invoiceNoContainer}>
            ...
            <Text style={styles.label}> : </Text>
            <Text style={styles.rightvalue}>$ {accountHeader.outstanding_balance}</Text>
          </View>
          <View style={styles.invoiceNoContainer}>
