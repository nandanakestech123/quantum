...
export class AddressClass extends React.Component {
  ...
  componentWillMount() {
    ...
    console.log(
      "this.props.formFieldsBillingStored.to",
      this.props.formFieldsBillingStored.to
    );
    this.autofillSaved();
  }
  ...
  autofillSaved = () => {
    ...
    formFieldsBilling.postalCode =
      this.props.formFieldsBillingStored.postalCode;
    ...
    formFieldsShipping.postalCode =
      this.props.formFieldsShippingStored.postalCode;
...
export const Address = withTranslation()(
  connect(null, mapDispatchToProps)(AddressClass)
);
