...
export class ListStocksAdjustmentClass extends React.Component {
  state = {
    headerDetails: [
      { label: "Date" },
      { label: "DOC Number" },
  ...
  getADJ = () => {
    let { ADJList, pageMeta, formField, page, limit, statusOption, empOption } =
      this.state;
    ...
    this.props
      .getCommonApi(
        `stockadjlist/?searchfrom=${dateFormat(
          From,
          "yyyy-mm-dd"
  ...
  render() {
    ...
    return (
      <div className="adjustment-section col-md-11 align-items-center">
        <div className="col-md-12">
          <p className="label-head mb-4">{t("Stocks Adjustment Listing")}</p>
        </div>
        ...
        <div className="d-flex flex-wrap m-0 filter">
          ...
          <div className="col-md-2 col-12">
            ...
            <NormalButton
              ...
              outline={false}
              onClick={() => history.push("inventory/stocksadjustment/add")}
            />
          </div>
        </div>
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            <div className="d-flex align-items-center justify-content-center">
                              <Link
                                to={`inventory/stocksadjustment/${PO_ID}/edit`}
                              >
                                {DOC_NO}
                              </Link>
                            </div>
...
export const ListStocksAdjustment = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(ListStocksAdjustmentClass)
);
