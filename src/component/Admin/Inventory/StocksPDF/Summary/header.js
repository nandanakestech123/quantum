    ...
    return (
      <View style={styles.container} fixed>
        ...
        <View style={styles.headerText}>
          <Text style={styles.headerTitle}>{summary.storeName}</Text>
          <Text style={styles.headerTitle}>{summary.addr}</Text>
          
          <Text style={styles.headerTitle}>Stock Movement - Summary</Text>
