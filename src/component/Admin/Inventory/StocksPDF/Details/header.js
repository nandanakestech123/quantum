    ...
    return (
      <View style={styles.container} fixed>
        ...
        <View style={styles.headerText}>
          <Text style={styles.headerTitle}>{details.storeName}</Text>
          <Text style={styles.headerTitle}>{details.addr}</Text>
          
          <Text style={styles.headerTitle}>Stock Movement - Detail</Text>
