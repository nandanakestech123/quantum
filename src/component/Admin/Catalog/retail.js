...
export class RetailClass extends Component {
  state = {
    productCard: [
      {
        stock: true,
  ...
  render() {
    let { activeTab, menuId, rangeId } = this.state;
    return (
      <>
        <ServicesItem
          id={this.props.id}
...
export const Retail = connect(mapStateToProps, mapDispatchToProps)(RetailClass);
