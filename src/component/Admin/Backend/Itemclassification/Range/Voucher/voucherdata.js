...
export default class ItemrangevoucherClass extends Component {
  state = {
    code: null,
    desc: null,
    brandlist: [],
...
export const Itemrangevoucher = withTranslation()(
  connect(null, mapDispatchToProps)(ItemrangevoucherClass)
);
