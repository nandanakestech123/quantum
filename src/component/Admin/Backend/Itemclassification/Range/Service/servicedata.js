...
import { NewItemRanges, ItemDepts, rangelists } from "redux/actions/Backend";
import { connect } from "react-redux";
import { bindActionCreators } from "redux";
import { Toast } from "service/toast";

export default class ItemrangeserviceClass extends Component {
  state = {
    code: null,
    desc: null,
    brandlist: [],
...
export const Itemrangeservice = withTranslation()(
  connect(null, mapDispatchToProps)(ItemrangeserviceClass)
);
